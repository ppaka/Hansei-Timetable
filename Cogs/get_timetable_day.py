...
class get_timetable_day(commands.Cog):
    ...
    async def request_get(self, interaction: Interaction, grade: int, dddep_name: Optional[app_commands.Choice[str]] = None, class_name: int = 1, weekday: Optional[app_commands.Choice[int]] = None, date: Optional[int] = None) -> None:
